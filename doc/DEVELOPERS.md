...
``` sh
dnf install git gcc clang clang-analyzer clang-tools-extra cmake make liburing-devel pkgconf openssl openssl-devel systemd systemd-devel libyaml libyaml-devel python3-docutils libatomic zlib zlib-devel libzstd libzstd-devel lz4 lz4-devel bzip2 bzip2-devel libasan libasan-static
```
...
[**pgexporter**](https://github.com/pgexporter/pgexporter) is developed using the [C programming language](https://en.wikipedia.org/wiki/C_(programming_language)) so it is a good
